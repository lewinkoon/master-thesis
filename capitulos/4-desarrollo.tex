...
\begin{table}
    ...
    \begin{tabular}{lll}
        \toprule
        Tarea                 & Proceso   & Puesto     \\
        \midrule
        Identificar paciente  & Consultas & Ventanilla \\
        Asignar   profesional & Consultas & Ventanilla \\
        Asignar cita          & Consultas & Ventanilla \\
        Imprimir   cita       & Consultas & Ventanilla \\
        Lectura de volante    & Consultas & Ventanilla \\
        \bottomrule
    \end{tabular}
    \caption{Lista de tareas estandarizadas para el proceso de gestión de citas}
