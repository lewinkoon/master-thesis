...
Por el contrario, si el usuario acude al centro de salud\footnote{Ver diagrama BPMN de gestión de consultas en la Figura~\ref{fig:proceso-consultas}}, la cita se programa en el momento, entregando un justificante en papel.
...
Los \gls{electrocardiograma} se citan con el enfermero correspondiente reservando dos huecos de la agenda ya que son pruebas más largas.
...
Las extracciones de sangre\footnote{Ver diagrama BPMN de gestión de pruebas en la Figura~\ref{fig:proceso-pruebas}} se citan en los huecos de agenda con el mismo nombre.
...
Una vez obtenidas todas las pegatinas, es necesario comprobar que han salido todas y están correcamente impresas.
...
La gestión de agendas recoge todas la tareas relacionadas con la asignación de franjas de tiempo, o huecos, a los distintos profesionales y sus respectivas modificaciones. El diagrama expuesto en la Figura~\ref{fig:proceso-agendas} se muestra visualmente el proceso.
...
El proceso de reclamaciones se inicia, generalmente, cuando un usuario se acerca a la ventanilla de admisión solicitando poner una reclamación (ver Figura~\ref{fig:proceso-reclamaciones}).
...
La gestión de permisos retribuidos de los profesionales del centro de salud también recae en la sección administrativa (ver Figura~\ref{fig:proceso-permisos}).
